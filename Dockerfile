...
RUN mv /etc/privoxy/config /etc/privoxy/config.backup
ADD ./src/ubuntu/install/privoxy /etc/privoxy/config

##RUN service tor start
##RUN service privoxy start

ENV all_proxy="socks://localhost:9050/"
ENV http_proxy="http://localhost:8118/"
ENV https_proxy="http://localhost:8118/"
ENV ftp_proxy="http://localhost:8118/"
